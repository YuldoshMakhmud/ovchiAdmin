...
class CouponViewModel {
  ...
  updateCoupon({required String docId, required Map<String, dynamic> couponDataMap}) async {
    await FirebaseFirestore.instance.collection("coupons").doc(docId).update(couponDataMap);
  }
