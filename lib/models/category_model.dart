...
class CategoryModel {
  ...
  static List<CategoryModel> fromJsonList(List<QueryDocumentSnapshot> categoriesList) {
    return categoriesList.map((category) => CategoryModel.fromJson(category.data() as Map<String, dynamic>, category.id)).toList();
  }
}