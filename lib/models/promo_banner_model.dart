...
class PromoBannerModel {
  ...
  factory PromoBannerModel.fromJson(Map<String, dynamic> jsonData, String docID) {
  ...
  static List<PromoBannerModel> fromJsonList(List<QueryDocumentSnapshot> promosBannersList) {
    return promosBannersList.map((promoBanner) => PromoBannerModel.fromJson(promoBanner.data() as Map<String, dynamic>, promoBanner.id)).toList();
  }
