...
import 'package:ovchiadmin/models/product_model.dart';
import 'package:ovchiadmin/view_model/product_view_model.dart';
import 'package:file_picker/file_picker.dart';
import 'package:flutter/material.dart';
import 'package:image/image.dart' as img;
import '../widgets/category_text_form_field.dart';
...
class _UpdateProductsPageState extends State<UpdateProductsPage> {
  ...
  pickImageAndCompress() async {
    ...
    if (result != null && result.files.single.bytes != null) {
      ...
      if (originalImage != null) {
        final compressed = img.encodeJpg(originalImage, quality: 70);
        ...
        setState(() {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("Image compressed and set"),
              backgroundColor: Colors.green,
            ),
          );
        });
  ...
  displayDataOnTextFormField(ProductModel data) {
        ...
        child: Center(
          child: ConstrainedBox(
            constraints: BoxConstraints(
              ...
              minWidth: 300, // fallback for small screens
            ),
            child: Form(
              key: formGlobalKey,
              child: Column(
                children: [
                  ...
                  buildTextFormField(
                    ...
                    label: "Base64 Image",
                    validatorMsg: "Please Select an Image first.",
                    maxLines: 4,
                  ),
